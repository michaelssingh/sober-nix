...
"$NIX_CHROOT" "$NIX_STORE" bash -l -c "
    $NIX_BIN_PATH run --extra-experimental-features 'nix-command flakes' github:nix-community/home-manager/master -- switch --flake $FLAKE_URI --extra-experimental-features 'nix-command flakes' -b backup --refresh
"
