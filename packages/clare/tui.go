...
var (
	headerStyle = lipgloss.NewStyle().
			Bold(true).
			Foreground(lipgloss.Color("#bb9af7")) // Tokyonight purple

	panelTitleStyle = lipgloss.NewStyle().
			Bold(true).
			Foreground(lipgloss.Color("#c0caf5")) // Tokyonight text

	synBodyStyle = lipgloss.NewStyle().
			Foreground(lipgloss.Color("#a9b1d6")) // Tokyonight body text
...
func (m model) View() string {
	...
	baseTabs := func(active int) {
		...
		tabs = append(tabs, render("Continue Watching [1]", 1))
...
func doFetchJikanMetadata(malID, showName string, page int) tea.Cmd {
	return func() tea.Msg {
		metadata, err := FetchEpisodeMetadataCascade(malID, showName, page)
		if err != nil {
